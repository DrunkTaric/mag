...
function structureCommand(meta: MetaData, commands: any[]): RESTPostAPIChatInputApplicationCommandsJSONBody {
...
async function PullFiles() {
	let files: {[key: string]: { metadata: MetaData, commands: any[], callbacks: any[] }} = {}
